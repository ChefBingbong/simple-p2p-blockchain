...
async function testProtocolRegistration() {
  ...
  try {
    ...
    const nodeAPrivateKey = derivePrivateKey('eth-protocol-registration-test-a')
    const nodeBPrivateKey = derivePrivateKey('eth-protocol-registration-test-b')
    ...
    console.log('📋 Test 1: Checking ETH protocol registration with P2PNode...')
    ...
    console.log('📋 Test 2: Checking peer creation and ETH protocol binding...')
