...
export type LabelKeys<Labels extends LabelsGeneric> = Extract<
  keyof Labels,
  string
>
...
export interface Gauge<Labels extends LabelsGeneric = NoLabels> {
  inc: NoLabels extends Labels
    ? (value?: number) => void
    : (labels: Labels, value?: number) => void
  dec: NoLabels extends Labels
    ? (value?: number) => void
    : (labels: Labels, value?: number) => void
  set: NoLabels extends Labels
    ? (value: number) => void
    : (labels: Labels, value: number) => void
...
export interface GaugeExtra<Labels extends LabelsGeneric = NoLabels>
  extends Omit<Gauge<Labels>, 'collect'> {
  addCollect(collectFn: CollectFn<Labels>): void
}
...
export interface Histogram<Labels extends LabelsGeneric = NoLabels> {
  ...
  observe: NoLabels extends Labels
    ? (value: number) => void
    : (labels: Labels, value: number) => void
...
export interface AvgMinMax<Labels extends LabelsGeneric = NoLabels> {
  ...
  set: NoLabels extends Labels
    ? (values: number[]) => void
    : (labels: Labels, values: number[]) => void
}
