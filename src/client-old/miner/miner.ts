...
import {
	...
	type Solution,
} from "../../eth-hash/index.ts";
import { BIGINT_0, BIGINT_1, bytesToHex } from "../../utils/index.ts";
import { buildBlock, type TxReceipt } from "../../vm/index.ts";
...
export class Miner {
	...
	async assembleBlock() {
		...
		const { createBlock } = await import("../../block/index.ts");
